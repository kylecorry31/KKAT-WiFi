 ...
 */
public class OMINNTutorialContent extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        title.setText(getString(R.string.obstruction_detection));
        content.setText(getString(R.string.content_obstruction_detection));
