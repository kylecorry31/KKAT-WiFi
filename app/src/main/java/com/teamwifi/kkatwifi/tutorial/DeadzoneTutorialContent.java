 ...
 */
public class DeadzoneTutorialContent extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        title.setText(getString(R.string.deadzone_detection));
        content.setText(getString(R.string.content_deadzone_detection));
